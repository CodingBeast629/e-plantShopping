...
// ✅ Step 5: import addItem from CartSlice
...
function ProductList({ onHomeClick }) {
  ...
  // ✅ Step 4: track which plants have been added (by name)
  ...
  // ✅ Step 5: Add to cart function: dispatch + update local state
          ...
          {plantsArray.map((categoryObj) =>
            categoryObj.plants.map((plant) => (
              <div className="product-card" key={`${categoryObj.category}-${plant.name}`}>
                ...
                {/* ✅ Step 3 + 4 + 5: button + addedToCart state */}
                <button
